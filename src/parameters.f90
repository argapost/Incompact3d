...
subroutine parameter(input_i3d)
  ...
  NAMELIST /InOutParam/ irestart, icheckpoint, ioutput, nvisu, iprocessing, f_output, f_input, f_Ux1_m
...
subroutine parameter_defaults()
  ...
  imodulo2 = 1
  f_input = 'default' ! inpute netcdf file name (Argyris)
  f_output = 'default' ! output netcdf file init (Argyris)
  f_Ux1_m = 'default' ! default input mean vel
